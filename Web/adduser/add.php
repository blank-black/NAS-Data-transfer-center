...
<?php
  ...
  if ( $user == "" || $passwd == ""){
     ...
     echo "<font color='red'>您必须输入用户名与密码</font>"; 
       ...
       if ($result=="no"){
           echo "<br/>";
           echo "<font color='red' size='5'>您输入的用户已存在，请重新输入,程序2秒返回添加页面</font>";
           echo "<br/>";
           ...
           echo "<font color='green'>添加用户</font>"."<font color='green' size='8'>$user</font>"."<font color='green'>成功!</font>.<img src='../images/small.jpg' width='50px' height='50px'/>";
